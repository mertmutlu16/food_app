...
import 'package:food_app/detail_screen/model/apis/add_to_favorite_api.dart';
...
abstract class _DetailScreenViewModelBase with Store {
  ...
  final AddToFavoriteApi _addToFavoriteApi = AddToFavoriteApi();
  ...
  Future addFavorite(int userId, int foodId ) async {
    await _addToFavoriteApi.addFavorite(userId, foodId).catchError((err) {
      debugPrint(err.toString());
    });
  }
}
